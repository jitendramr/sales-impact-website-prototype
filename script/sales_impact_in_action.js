...
/* Function to launch courses */

var topic1ModuleList = new Array('','si_wmassp_v20');
var topic2ModuleList = new Array('','');
var topic3ModuleList = new Array('','si_aut_v20');
var topic4ModuleList = new Array('','');
var topic5ModuleList = new Array('','');
var topic6ModuleList = new Array('','');
var topic7ModuleList = new Array('','');
var topic8ModuleList = new Array('','');
var topic9ModuleList = new Array('','');

function launchCourse(argTopic,argModule){
	var folderName=eval("topic" + argTopic + "ModuleList")[argModule];
	window.open("courses/"+folderName+"/default.htm");
}
